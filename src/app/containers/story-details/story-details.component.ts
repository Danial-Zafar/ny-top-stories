...
export class StoryDetailsComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private storeService: StoreService, private apiService: ApiService) {
  ...
  getArticalReviews() {
    this.apiService.get(AppApiUrls.NY.getStoryReviewByUrl(this.item.url, environment.api_key))
    .subscribe({
       next: (response : any) => {
